...
import { GETLoginPage, GETRegisterPage, POSTLoginPage, POSTRegisterPage, GETProfilePage, POSTUpdateProfile, GETHistoryPage, GETLogout } from '../controllers/customerController.mjs';
